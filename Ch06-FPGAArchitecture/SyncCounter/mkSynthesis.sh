...
for vfile in counterNAE.v counterNSE.v counterPAE.v counterPSE.v counterPSN.v counterPAN.v
do
     ...
     yosys -Q -T -q -p "read_verilog $vfile; 
	       show -notitle -format dot -prefix $dfile1; 
	       proc; opt; 
	       show -notitle -format dot -prefix $dfile2; 
	       synth_ice40; 
