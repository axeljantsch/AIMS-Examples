...
do
	...
	do
	    ...
	    vcdf=`make -s --no-print-directory -C $arch scenario=$scen genvcdfile`    # generated vcd file
	    inf=`make  -s --no-print-directory -C $arch scenario=$scen gencominfile`  # generated by simulation
	    outf=`make -s --no-print-directory -C $arch scenario=$scen gencomoutfile` # generated by simulation
